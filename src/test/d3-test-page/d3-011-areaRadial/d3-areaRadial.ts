...
// http://ko.wordow.com/english/dictionary/angle
// https://runebook.dev/en/docs/d3/d3-shape?page=4#areas
...
function example1() {
  ...
  */
  ...
  d3.select("svg").append("g").attr("transform", "translate(150, 150)").append("path")
    .attr("class", "arc")
    .attr("d", function(d) {
      return d3.arc()({
        innerRadius: 2,
