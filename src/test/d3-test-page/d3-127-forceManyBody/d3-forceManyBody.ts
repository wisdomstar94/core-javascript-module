...
window.addEventListener('load', async() => {  
  ...
  */
  ...
  const simulation = d3.forceSimulation(data)
    .force("collide", d3.forceCollide().radius(10).strength(3)) // strength 값이 높을수록 요소들이 더 멀리 떨어짐.
    /*
    ...
    */
    .force("manyBody", d3.forceManyBody().strength(250).distanceMax(150).distanceMin(50))
